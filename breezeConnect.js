...
var BreezeConnect = function(params) {
    ...
    self.version = "0.1";
    self.appKey = params.appKey || "01944s0iT703549692A57L89_&2781@5";
    self.userId = "";
    self.secretKey = "7g5728B8r*Dn_0s710u09r3G4916e74K";
    self.socket = null;
    self.socketOrder = null;
    self.socketOHLCV = null;
    self.sessionKey = "34890413";
    self.apiSession = "";
    self.onTicks = null;

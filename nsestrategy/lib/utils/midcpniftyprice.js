...
async function Nifty(fixStrikePriceCE, fixStrikePricePE){
    ...
    try{
        ...
        execSync(`curl 'https://www.nseindia.com/api/option-chain-indices?symbol=MIDCPNIFTY' \
    ...
    const data = await fetch("https://www.nseindia.com/api/option-chain-indices?symbol=MIDCPNIFTY", {
        "headers": {
          "accept": "*/*",

...
async function Nifty(fixStrikePriceCE, fixStrikePricePE){
    ...
    try{
        ...
        execSync(`curl 'https://www.nseindia.com/api/option-chain-indices?symbol=NIFTY' \
    ...
    const data = await fetch("https://www.nseindia.com/api/option-chain-indices?symbol=NIFTY", {
        "headers": {
          "accept": "*/*",

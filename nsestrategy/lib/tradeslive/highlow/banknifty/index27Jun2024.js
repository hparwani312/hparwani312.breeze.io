...
function starttrade(from = 20, to = 30, expiryDateInput="03-Jul-2024"){
    ...
    const fromDate = "2024-07-03 09:15:00"
        ...
        const {
          ...
          if(open < close){
            ...
            if(trend === 'down'){
                ...
                if((currentLowerHigh>(lowerHigh+10) && lowerHigh>0 && strikePrice)|| (lowerHigh <=0 && close >= lowerLow+45) ||  lowerBreakCounter > 5){
          ...
          "strikePrice":strikePrice,
              ...
              "strikePrice":strikePrice,
                ...
                if((startPriceCount>7&& close>=(startPrice+45)) || (close > (startPrice+100) && startPrice > 0)){
                    trend="up";
                console.log("up head here first", startPriceCount>7,(close > (startPrice+100)), close, startPrice );   
          ...
          "strikePrice":strikePrice,
            ...
            if(lowerStartPrice===0 && startPrice===0){
                ...
                if(close<higherLow-10 && higherLow>0){
                    startPrice = 0;
                    startPriceCount = 0;
            ...
            if(((lowerStartPriceCount>7 && close<=(lowerStartPrice-45)) || (close<(lowerStartPrice-100) )) && lowerStartPrice >0){
                trend="down";
                console.log("down head here first", lowerStartPriceCount>7, close<(lowerStartPrice-100), close, lowerStartPrice );   
                while(true){
